...
const footerSections: FooterSection[] = [
  {
    title: "ซีรีย์",
    links: [
      { label: "ซีรีย์ยอดนิยม", href: "/trending" },
      { label: "ซีรีย์ใหม่", href: "/series?sort=newest" },
      { label: "ไมโครดราม่า", href: "/categories/micro-drama" },
      { label: "ซีรีย์แนวตั้ง", href: "/categories/vertical" },
    ],
  },
  {
    title: "หมวดหมู่",
    links: [
      { label: "โรแมนติก", href: "/categories/romance" },
      { label: "แอ็คชั่น", href: "/categories/action" },
      { label: "ตลก", href: "/categories/comedy" },
      { label: "ดราม่า", href: "/categories/drama" },
    ],
  },
  {
    title: "บัญชีผู้ใช้",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-sm text-muted mb-4">
              แพลตฟอร์มสตรีมมิ่งซีรีย์ไมโครดราม่า ซีรีย์แนวตั้ง และซีรีย์สั้น
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2 rounded-lg bg-muted-light dark:bg-muted-dark text-muted hover:text-foreground transition-colors"
